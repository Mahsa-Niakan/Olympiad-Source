        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Session.currentGroupId == 1)
                {
                    ...
                    Correction.WordPracticalCorrection(questionId, 5, t1);
                    View.Question6 f = new Question6();
                    f.Show();
                    this.Hide();
                }
                ...
                {
                    timer1.Enabled = false;
                    Correction.PowerPointPracticalCorrection(questionId, 5, t1);
                    View.Question6 f = new Question6();
                    f.Show();
                    this.Hide();
                }
                ...
                {
                    timer1.Enabled = false;
                    Correction.ExcelPracticalCorrection(questionId, 5, t1);
                    View.Question6 f = new Question6();
                    f.Show();
                    this.Hide();
                }
