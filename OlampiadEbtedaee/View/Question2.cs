...
namespace OlampiadEbtedaee.View
{
    public partial class Question2 : Form
    {
        ...
        {
            if (Session.currentGroupId == 4 || Session.currentGroupId == 5 || Session.currentGroupId == 3)
            ...
            else
            {
                ...
                if (Session.currentGroupId == 1)
                {
                    ...
                    Correction.WinPracticalCorrection(questionId, 2, t1);
                    View.Question3 f = new Question3();
                    f.Show();
                    this.Hide();
                }
                if (Session.currentGroupId == 2)
                ...
                {
                    timer1.Enabled = false;
                    Correction.WordPracticalCorrection(questionId, 2, t1);
                    View.Question3 f = new Question3();
                    f.Show();
                    this.Hide();
                }
                ...
                {
                    timer1.Enabled = false;
                    Correction.PowerPointPracticalCorrection(questionId, 2, t1);
                    View.Question3 f = new Question3();
                    f.Show();
                    this.Hide();
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (Session.currentGroupId == 4 || Session.currentGroupId == 5 || Session.currentGroupId == 3)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    View.Question3 f = new View.Question3();
                    f.Show();
                    this.Hide();
                }
                else
