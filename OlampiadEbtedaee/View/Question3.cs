...
namespace OlampiadEbtedaee.View
{
    public partial class Question3 : Form
    {
        ...
        {
            if (Session.currentGroupId == 3 || Session.currentGroupId == 4)
                System.Diagnostics.Process.Start(@"D:\" + Session.currentUserId + @"\PowerPoint");
            ...
            {
                var q = (from c in Session.DB.PowerPointQuestionSet
        ...
        {
            if (Session.currentGroupId == 4 || Session.currentGroupId == 5 || Session.currentGroupId == 3 || Session.currentGroupId == 2)
            ...
            else
            {
                ...
                if (Session.currentGroupId == 1)
                {
                    ...
                    Correction.WinPracticalCorrection(questionId, 3, t1);
                    View.Question4 f = new Question4();
                    f.Show();
                    this.Hide();
                }
                ...
                {
                    timer1.Enabled = false;
                    Correction.WordPracticalCorrection(questionId, 3, t1);
                ...
                {
                    timer1.Enabled = false;
                    Correction.PowerPointPracticalCorrection(questionId, 3, t1);
                ...
                {
                    timer1.Enabled = false;
                    Correction.ExcelPracticalCorrection(questionId, 3, t1);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            if (Session.currentGroupId == 4 || Session.currentGroupId == 5 || Session.currentGroupId == 3 || Session.currentGroupId == 2)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    View.Question4 f = new View.Question4();
                    f.Show();
                    this.Hide();
                }
                else
