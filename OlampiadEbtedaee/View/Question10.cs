    ...
    public partial class Question10 : Form
    {
        ...
        private void Question10_Load(object sender, EventArgs e)
        {
            ...
            if (Session.currentGroupId == 5)
            {
                var q = (from c in Session.DB.WindowsTheorySet
                         where c.Level == "0" && c.Grade == 6 && c.Repeatitive == "0"
                         select c).OrderBy(x => Guid.NewGuid()).Take(1).Single();
                textBox1.Text = q.Text;
                radioButton1.Text = q.ChoiceOne;
                radioButton2.Text = q.ChoiceTwo;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Session.currentGroupId == 1)
                {
                    Correction.WordTheory(questionId, 10, t1, ch);
                }
                if (Session.currentGroupId == 2)
                {
                    Correction.PowerPointTheory(questionId, 10, t1, ch);
                }
                if (Session.currentGroupId == 3)
                {
                    Correction.excelTheory(questionId, 10, t1, ch);
                }
                if (Session.currentGroupId == 4)
                {
                    Correction.excelTheory(questionId, 10, t1, ch);
                ...
                {
                    // internet :
                    Correction.WinTheory(questionId, 10, t1, ch);
                }
